...
# Groups: toolchain/vendored (incl. deps published with a remapped
# `<WORKSPACE>` source prefix, e.g. tokio/tracing macro expansions);
# generated code + test scaffolding; primitives
...
COV_IGNORE='(/\.cargo/|/rustc/|<WORKSPACE>/|weights\.rs|runtime_api\.rs|mock\.rs|benchmarking\.rs|/primitives/|subxt_client\.rs|_subxt\.rs|clients/[^/]+/src/|clients/[^/]+/tests/|src/replica_sync\.rs|src/main\.rs|src/cli\.rs|src/command\.rs)'
