...
//! HOSTNAME: `4292d4c7920c`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> pallet_drive_registry::WeightInfo for WeightInfo<T> {
	...
	fn create_drive() -> Weight {
		...
		//  Measured:  `1514`
		//  Estimated: `11515`
		// Minimum execution time: 118_636_000 picoseconds.
	...
	fn delete_drive() -> Weight {
		...
		//  Measured:  `11980`
		//  Estimated: `1053490`
		// Minimum execution time: 599_128_000 picoseconds.
		Weight::from_parts(628_976_000, 0)
	...
	fn share_drive() -> Weight {
		...
		Weight::from_parts(47_197_000, 0)
			.saturating_add(Weight::from_parts(0, 11515))
	...
	fn unshare_drive() -> Weight {
		...
		//  Measured:  `4818`
		//  Estimated: `11515`
		// Minimum execution time: 47_266_000 picoseconds.
