...
impl<T: frame_system::Config> pallet_drive_registry::WeightInfo for WeightInfo<T> {
	...
	fn create_drive() -> Weight {
		...
		//  Measured:  `1510`
		//  Estimated: `11515`
		// Minimum execution time: 122_568_000 picoseconds.
	...
	fn delete_drive() -> Weight {
		...
		//  Measured:  `12149`
		//  Estimated: `1053490`
		// Minimum execution time: 651_361_000 picoseconds.
		Weight::from_parts(675_235_000, 0)
	...
	fn share_drive() -> Weight {
		...
		Weight::from_parts(48_483_000, 0)
			.saturating_add(Weight::from_parts(0, 11515))
