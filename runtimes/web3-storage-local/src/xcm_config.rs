...
use crate::constants::system_parachain::{ASSET_HUB_ID, COLLECTIVES_ID};
use frame_support::{
    parameter_types,
    traits::{
...
pub use crate::constants::locations::{GovernanceLocation, PeopleLocation};
...
parameter_types! {
    ...
    pub const BaseDeliveryFee: u128 = 3 * crate::constants::currency::MILLIUNIT;
    pub const DepositPerItem: Balance = crate::constants::currency::MILLIUNIT;
    pub const DepositPerByte: Balance = crate::constants::currency::MICROUNIT;
...
impl xcm_executor::Config for XcmConfig {
    ...
    type Weigher = WeightInfoBounds<
        crate::weights::xcm::Web3StorageXcmWeight<RuntimeCall>,
        RuntimeCall,
        MaxInstructions,
    >;
