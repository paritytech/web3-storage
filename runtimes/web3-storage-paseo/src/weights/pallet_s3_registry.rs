...
impl<T: frame_system::Config> pallet_s3_registry::WeightInfo for WeightInfo<T> {
	...
	fn create_s3_bucket() -> Weight {
		...
		//  Measured:  `1832`
		//  Estimated: `11515`
		// Minimum execution time: 129_964_000 picoseconds.
		Weight::from_parts(136_149_000, 0)
	...
	fn delete_s3_bucket() -> Weight {
		...
		//  Measured:  `2493`
		//  Estimated: `11515`
		// Minimum execution time: 89_798_000 picoseconds.
		Weight::from_parts(98_423_000, 0)
			.saturating_add(Weight::from_parts(0, 11515))
