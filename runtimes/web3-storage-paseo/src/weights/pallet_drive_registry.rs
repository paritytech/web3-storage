...
impl<T: frame_system::Config> pallet_drive_registry::WeightInfo for WeightInfo<T> {
	...
	fn create_drive() -> Weight {
		...
		//  Measured:  `1832`
		//  Estimated: `11515`
		// Minimum execution time: 127_192_000 picoseconds.
	...
	fn delete_drive() -> Weight {
		...
		//  Measured:  `12089`
		//  Estimated: `1053490`
		// Minimum execution time: 603_901_000 picoseconds.
		Weight::from_parts(629_695_000, 0)
	...
	fn share_drive() -> Weight {
		...
		Weight::from_parts(48_898_000, 0)
			.saturating_add(Weight::from_parts(0, 11515))
