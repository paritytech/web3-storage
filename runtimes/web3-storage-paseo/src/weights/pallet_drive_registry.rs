...
impl<T: frame_system::Config> pallet_drive_registry::WeightInfo for WeightInfo<T> {
	...
	fn create_drive() -> Weight {
		...
		//  Measured:  `1832`
		//  Estimated: `11515`
		// Minimum execution time: 126_411_000 picoseconds.
		Weight::from_parts(133_340_000, 0)
	...
	fn delete_drive() -> Weight {
		...
		//  Measured:  `12089`
		//  Estimated: `1053490`
		// Minimum execution time: 606_311_000 picoseconds.
		Weight::from_parts(634_142_000, 0)
	...
	fn unshare_drive() -> Weight {
		...
		Weight::from_parts(51_351_000, 0)
			.saturating_add(Weight::from_parts(0, 11515))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
