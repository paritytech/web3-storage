...
impl<T: frame_system::Config> pallet_drive_registry::WeightInfo for WeightInfo<T> {
	...
	fn create_drive() -> Weight {
		...
		Weight::from_parts(169_131_000, 0)
	...
	fn delete_drive() -> Weight {
		...
		//  Measured:  `12182`
		//  Estimated: `1053490`
		// Minimum execution time: 628_940_000 picoseconds.
		Weight::from_parts(644_404_000, 0)
	...
	fn share_drive() -> Weight {
		...
		//  Measured:  `4862`
		//  Estimated: `11515`
		// Minimum execution time: 46_871_000 picoseconds.
	...
	fn unshare_drive() -> Weight {
		...
		Weight::from_parts(49_436_000, 0)
			.saturating_add(Weight::from_parts(0, 11515))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
