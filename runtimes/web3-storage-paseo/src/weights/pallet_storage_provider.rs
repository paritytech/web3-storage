...
impl<T: frame_system::Config> pallet_storage_provider::WeightInfo for WeightInfo<T> {
	...
	fn complete_deregister() -> Weight {
		...
		//  Measured:  `45127`
		//  Estimated: `2566553`
		// Minimum execution time: 3_664_000_000 picoseconds.
		Weight::from_parts(3_755_000_000, 0)
	...
	fn provider_checkpoint(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_072_254, 0)
			.saturating_add(Weight::from_parts(0, 4029))
			// Standard Error: 41_548
			.saturating_add(Weight::from_parts(24_179_264, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
