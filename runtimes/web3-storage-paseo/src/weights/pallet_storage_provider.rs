...
impl<T: frame_system::Config> pallet_storage_provider::WeightInfo for WeightInfo<T> {
	...
	fn complete_deregister() -> Weight {
		...
		//  Measured:  `45127`
		//  Estimated: `2566553`
		// Minimum execution time: 3_699_000_000 picoseconds.
		Weight::from_parts(3_779_000_000, 0)
	...
	fn end_agreement(a: u32, ) -> Weight {
		...
		Weight::from_parts(46_650_510, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			// Standard Error: 76_217
			.saturating_add(Weight::from_parts(20_724_489, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn provider_checkpoint(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_890_712, 0)
			.saturating_add(Weight::from_parts(0, 4029))
			// Standard Error: 17_474
			.saturating_add(Weight::from_parts(24_134_637, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
