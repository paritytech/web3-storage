 ...
 * (decimals/symbol/block time) and the SS58 prefix used to encode addresses.
 * Returns the chain identity (name / runtime spec version / genesis hash) for
 * the caller to publish into chain state.
 */
