 ...
 *
 * Currently holds the auto-refresh interval used to periodically re-fetch the
 * network snapshot. `0` means auto-refresh is off.
 */

import { BehaviorSubject } from 'rxjs'
import { bind } from '@react-rxjs/core'

const AUTO_REFRESH_KEY = 'explorer-auto-refresh-secs'
