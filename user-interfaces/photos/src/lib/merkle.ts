...
// per-file data root, so the browser can compute the on-chain integrity anchor
...
//
// Pure functions, no I/O — the browser twin of `scripts/lib/merkle.ts` (M2/M3),
// reused by the M6 upload/anchor path.
