...
impl<T: frame_system::Config> pallet_storage_provider::WeightInfo for WeightInfo<T> {
	...
	fn complete_deregister() -> Weight {
		...
		//  Measured:  `45127`
		//  Estimated: `2566553`
		// Minimum execution time: 3_639_000_000 picoseconds.
		Weight::from_parts(3_811_000_000, 0)
	...
	fn end_agreement(a: u32, ) -> Weight {
		...
		Weight::from_parts(46_937_244, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			// Standard Error: 81_720
			.saturating_add(Weight::from_parts(19_487_755, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn provider_checkpoint(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_765_829, 0)
			.saturating_add(Weight::from_parts(0, 4029))
			// Standard Error: 61_150
			.saturating_add(Weight::from_parts(23_784_988, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
