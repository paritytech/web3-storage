...
impl<T: frame_system::Config> pallet_storage_provider::WeightInfo for WeightInfo<T> {
	...
	fn complete_deregister() -> Weight {
		...
		//  Measured:  `45127`
		//  Estimated: `2566553`
		// Minimum execution time: 3_490_000_000 picoseconds.
		Weight::from_parts(3_661_000_000, 0)
	...
	fn end_agreement(a: u32, ) -> Weight {
		...
		Weight::from_parts(45_483_673, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			// Standard Error: 147_900
			.saturating_add(Weight::from_parts(20_091_326, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn provider_checkpoint(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_685_922, 0)
			.saturating_add(Weight::from_parts(0, 4029))
			// Standard Error: 65_269
			.saturating_add(Weight::from_parts(23_495_268, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
