...
impl<T: frame_system::Config> pallet_storage_provider::WeightInfo for WeightInfo<T> {
	...
	fn complete_deregister() -> Weight {
		...
		//  Measured:  `45127`
		//  Estimated: `2566553`
		// Minimum execution time: 3_620_000_000 picoseconds.
		Weight::from_parts(3_785_000_000, 0)
	...
	fn end_agreement(a: u32, ) -> Weight {
		...
		Weight::from_parts(46_523_979, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			// Standard Error: 93_509
			.saturating_add(Weight::from_parts(20_951_020, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn provider_checkpoint(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_845_151, 0)
			.saturating_add(Weight::from_parts(0, 4029))
			// Standard Error: 49_996
			.saturating_add(Weight::from_parts(24_247_955, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn respond_to_challenge_proof() -> Weight {
		...
		Weight::from_parts(436_000_000, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
