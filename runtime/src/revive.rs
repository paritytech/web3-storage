...
use crate::{
    constants::currency::UNIT, Address, Balance, Balances, Runtime, RuntimeCall, RuntimeEvent,
    RuntimeHoldReason, RuntimeOrigin, Signature, Timestamp, TxExtension,
};
...
impl pallet_revive::Config for Runtime {
    ...
    type ChainId = ConstU64<420_420_500>;
